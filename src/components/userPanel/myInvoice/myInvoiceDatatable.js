        ...
        return (
          <Link
            ...
            onClick={async () => {
              ...
              this.props.history.push(`/user-my-invoice/${parcelObj.parcelId}`);
            }}
          >
            <i className="icofont-tick-mark"></i> Paid
          </Link>
        );
      } else {
        return (
          ...
          >
            <i className="icofont-location-arrow"></i> pay
          </Link>
        );
      }
    } else {
...
export default withRouter(connect(null, { setParcelObj })(Datatable));
