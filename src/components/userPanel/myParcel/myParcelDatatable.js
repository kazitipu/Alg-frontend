    ...
    if (myData.length > 0) {
      ...
      myData.forEach((parcel) => {
        ...
        newData.push({
          ...
          "Product Name": parcel.productName,
          "Product Quantity": parcel.quantity,
          "Total Weight": `${parcel.grossWeight}kg`,
          "Total CBM": parcel.totalCbm,
          "Chargeable Weight": `${parcel.totalCbm * 167}kg`,
        });
      });
      return (
        <div
